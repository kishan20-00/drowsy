...
counter = 0 
counterLabel = ctk.CTkLabel(master=app, text=counter,  height=40, width=120, text_color="white", fg_color="teal")  # Remove text_font
counterLabel.pack(pady=10)

def reset_counter(): 
    global counter
    counter = 0 
resetButton = ctk.CTkButton(master=app, text="Reset Counter", command=reset_counter, height=40, width=120, text_color="white", fg_color="teal")  # Remove text_font
resetButton.pack()
