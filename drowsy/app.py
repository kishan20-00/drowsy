...
vidFrame.pack()
vid = ctk.CTkLabel(master=vidFrame)  # Specify master=vidFrame
vid.pack()

counter = 0 
counterLabel = ctk.CTkLabel(master=app, text=counter,  height=40, width=120, text_color="white", fg_color="teal")  # Specify master=app
counterLabel.pack(pady=10)

def reset_counter(): 
    global counter
    counter = 0 
resetButton = ctk.CTkButton(master=app, text="Reset Counter", command=reset_counter, height=40, width=120, text_color="white", fg_color="teal")  # Specify master=app
resetButton.pack()
